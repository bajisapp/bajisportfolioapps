  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
      <form action="https://getform.io/f/02ad1889-6d9f-417b-a772-ee378058b5df" method="POST" className='flex flex-col max-w-[600px] w-full '>
        ...
        <button type="submit" className='text-white border-2 hover:bg-blue-600 hover:border-blue-300 px-4 py-4 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
